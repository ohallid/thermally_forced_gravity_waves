function [ xx, zz, psi, ww] = series_half_sinusoid_plots(HL_bar , HV_bar, t, T, sigma)
...
ww  = HL_bar * HL_bar / pi / pi * ww;
% factor Q to control magnitude of heating
Q   = 1;
ww  = Q * ww;
